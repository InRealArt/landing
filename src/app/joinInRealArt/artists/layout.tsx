...
export const metadata: Metadata = generateStaticMetadata({
  ...
  alternateLanguages: {
    'fr': `${process.env.NEXT_PUBLIC_SITE_URL || 'https://inrealart.com'}/fr/joinInRealArt/artists`,
    'en': `${process.env.NEXT_PUBLIC_SITE_URL || 'https://inrealart.com'}/en/joinInRealArt/artists`
  }
})
