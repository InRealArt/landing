        ...
        <div className="bg-[rgb(30,30,30)] rounded-2xl p-8">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div className="lg:w-3/5">
              ...
              {/* Titre principal */}
              <h2 className="bricolage-grotesque text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
              ...
              <button className="bg-purpleColor border bg-backgroundColor p-4 gap-4 rounded-xl items-center inline-flex hover:bg-purpleColor/90 transition-colors">
                <span className='unbounded font-semibold text-sm text-white'>{t('academy.section3.button')}</span>
