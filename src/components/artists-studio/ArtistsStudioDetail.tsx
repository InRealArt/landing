  ...
  if (!artist) {
    return (
      <div className="bg-cardBackground border border-dashed border-borderColor p-8 text-center flex flex-col items-center justify-center h-[520px]">
        ...
        <p className="text-sm uppercase tracking-[0.25em] montserrat text-grayText max-w-xs leading-relaxed mt-2">
  ...
  return (
    <div className="flex flex-col bg-cardBackground">
      ...
      <div className="flex flex-col pt-5 pb-6 px-5 border border-t-0 border-borderColor space-y-4">
        ...
        <div>
          <p className="text-xs uppercase tracking-[0.35em] text-grayText montserrat mb-2">
          ...
          {artist.bio.length > BIO_TRUNCATE_LENGTH && (
            <button
              ...
              className="mt-2 text-sm uppercase tracking-[0.25em] montserrat text-gold-accent hover:text-textColor transition-colors underline underline-offset-4"
            >
        ...
        <div className="pt-4 border-t border-borderColor space-y-2">
          <div className="flex items-center gap-3 text-sm montserrat text-grayText uppercase tracking-wider">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 text-sm uppercase tracking-[0.35em] montserrat border border-gold-accent text-textColor px-4 py-2.5 hover:bg-gold-accent hover:text-white transition-all duration-300 self-start"
        >
        ...
        {artist.googleBusinessProfileUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-sm uppercase tracking-[0.35em] montserrat border border-borderColor text-textColor px-4 py-2.5 hover:border-gold-accent transition-all duration-300 self-start"
          >
