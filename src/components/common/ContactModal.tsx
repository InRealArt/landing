    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-cardBackground border border-white/20 rounded-xl p-8 mx-4 max-w-md w-full shadow-2xl">
        ...
        <div className="text-center">
          <h3 className="text-2xl font-medium bricolage-grotesque text-white mb-6">
            {title}
          </h3>
          
          <p className="text-gray-300 inter leading-relaxed mb-6">
            {message}
          </p>
          
          <a
            href="mailto:teaminrealart@gmail.com"
            className="inline-flex items-center justify-center px-6 py-3 bg-purpleColor text-white rounded-lg hover:bg-purpleColor/90 transition-colors font-medium"
          >
