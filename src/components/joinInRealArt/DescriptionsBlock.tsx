          ...
          <div className='rounded-2xl p-4 md:p-6 bg-cardBackground'>
            <div className="flex flex-col md:flex-row gap-4 md:gap-6">
              <div className="md:w-2/5">
                <div className={`relative w-full rounded-xl overflow-hidden ${theme === 'light' ? 'bg-gray-100' : 'bg-[rgb(20,20,20)]'}`}>
              ...
              <div className="md:w-3/5 flex items-center">
                <div>
                  ...
                  <p className='text-sm md:text-base leading-relaxed text-grayText'>
                    <TranslatedText
          ...
          <div className='rounded-2xl p-4 md:p-6 bg-cardBackground'>
            <div className="flex flex-col md:flex-row gap-4 md:gap-6">
              ...
              <div className="md:w-2/5 order-1 md:order-2">
                <div className='relative w-full rounded-xl overflow-hidden bg-backgroundColor'>
                  <OptimizedContentImage
