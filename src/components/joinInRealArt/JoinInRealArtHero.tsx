  ...
  return (
    <header className="pt-[calc(var(--header-height,90px)+4rem)] md:pt-[calc(var(--header-height,90px)+6rem)] lg:pt-[calc(var(--header-height,90px)+8rem)] pb-16 md:pb-24 lg:pb-32 px-4 sm:px-6 lg:px-10">
      <div className="max-w-screen-2xl mx-auto text-center">
        <span className="text-xs uppercase tracking-[0.3em] sm:tracking-[0.5em] text-grayText mb-6 block font-[family-name:var(--font-montserrat)]">
        ...
        <p className="text-sm sm:text-sm uppercase tracking-[0.2em] sm:tracking-[0.3em] text-grayText max-w-2xl mx-auto leading-relaxed font-[family-name:var(--font-montserrat)]">
