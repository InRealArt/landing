      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex justify-between py-2 border-b border-white/20">
            ...
            <span className="text-white font-unbounded">{formData.email}</span>
          </div>
          
          <div className="flex justify-between py-2 border-b border-white/20">
            <span className="font-medium text-white/70 font-unbounded">{t('loaSimulator.results.summary.company')}</span>
            <span className="text-white font-unbounded">{formData.company}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex justify-between py-2 border-b border-white/20">
            ...
            <span className="text-white font-unbounded">{formData.taxRate}%</span>
          </div>
          
          <div className="flex justify-between py-2 border-b border-white/20">
            <span className="font-medium text-white/70 font-unbounded">{t('loaSimulator.results.summary.artworkValue')}</span>
            <span className="text-white font-unbounded">{formatCurrency(formData.artworkValue)}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex justify-between py-2 border-b border-white/20">
            ...
            <span className="text-white font-unbounded">{formData.leaseDuration} {t('loaSimulator.results.summary.months')}</span>
          </div>
          
          <div className="flex justify-between py-2 border-b border-white/20">
            <span className="font-medium text-white/70 font-unbounded">{t('loaSimulator.results.summary.firstRentIncrease')}</span>
            <span className="text-white font-unbounded">{formData.firstRentIncrease ? t('loaSimulator.results.summary.yes') : t('loaSimulator.results.summary.no')}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex justify-between py-2 border-b border-white/20">
            ...
            <span className="text-white font-unbounded">{formatCurrency(leaseResults.firstMonthRent)}</span>
          </div>
          
          <div className="flex justify-between py-2 border-b border-white/20">
            <span className="font-medium text-white/70 font-unbounded">{t('loaSimulator.results.summary.monthlyRent')}</span>
            <span className="text-white font-unbounded">{formatCurrency(leaseResults.monthlyRent)}</span>
          </div>
        </div>
