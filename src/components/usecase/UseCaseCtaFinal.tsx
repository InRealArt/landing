  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-sm montserrat font-light leading-relaxed mb-12 text-grayText">
          {t('usecase.ctaFinal.subtitle')}
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/usecase/capital/contact"
            className="inline-flex items-center gap-3 border border-gold-accent text-textColor px-8 py-4 text-xs uppercase tracking-[0.4em] montserrat hover:bg-gold-accent hover:text-white transition-all duration-300"
          >
